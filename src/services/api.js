...
export default {
  ...
  // Get the analytics Fitts data for a specific player
  ...
  // Get constant values used in Fitts' Law calculations for a player
  ...
  async getPlayerHistory(playerId) {
    const res = await fetch(`${API_URL}/analytics/history/${playerId}`);
